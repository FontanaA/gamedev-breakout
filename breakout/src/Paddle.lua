...
function Paddle:init(skin)
    ...
    self.size = 2 --TODO should only need to change this based on health, and pionts... yeaaaaaa
    --[[
    size:size
    1 = 32
    2= 64
...
function Paddle:render()
    --TODO update
    love.graphics.draw(gTextures['main'], gFrames['paddles'][self.size + 4 * (self.skin - 1)],--[[4* skin is the colour, the size is the width rank]]
        self.x, self.y)
    --[[
    size:size
    1 = 32
